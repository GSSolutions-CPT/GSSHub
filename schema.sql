...
DROP INDEX IF EXISTS idx_invoices_quotation_id;
DROP INDEX IF EXISTS idx_quotation_lines_quotation_id;
DROP INDEX IF EXISTS idx_invoice_lines_invoice_id;
DROP INDEX IF EXISTS idx_jobs_client_id;
DROP INDEX IF EXISTS idx_jobs_quotation_id;
DROP INDEX IF EXISTS idx_expenses_job_id;
DROP INDEX IF EXISTS idx_expenses_invoice_id;
DROP INDEX IF EXISTS idx_activity_log_related_entity;
DROP INDEX IF EXISTS idx_calendar_events_datetime;
DROP INDEX IF EXISTS idx_recurring_contracts_client_id;
